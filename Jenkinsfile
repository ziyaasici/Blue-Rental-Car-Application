            ...
            steps {
                dir("Solution-Files/Task1/Terraform") {
                    script {
                        ...
                        sh(script: "terraform apply -auto-approve -var 'instance_type=${params.InstanceType}' -var 'ami=${params.AMI}' -var 'key_name=${params.Environment}-Keypair' -var 'tags={'Name'=Blue-Rental-${Environment}}'", returnStdout: true)
                    }
                }
            }
        }
